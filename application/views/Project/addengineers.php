  ...
  <div class="content-wrapper" style="background-image: url('<?php echo base_url('assets/back.jpg');?>')!important ;">
                    ...
                    <div class=" float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="#">Add Project Engineers</a></li>
    ...
    <section class="content container-fluid" style="margin-top: -30px;">
      <div class="content">
         <div class="card">
            <div class="card-body">
      <?php echo form_open_multipart('Project/insert_project_engineer');?>
                <div class="row">
                        ...
                        <div class="col-sm-4">
                          ...
                          <div class="col-sm-6">
                             <label for="engineer_assoc">Engineers</label>
                            ...
                            <?php echo form_error('engineer_assoc'); ?>

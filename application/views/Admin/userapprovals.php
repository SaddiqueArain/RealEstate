                        ...
                        <tbody>
                            <?php foreach($approvals as $row): ?>
                                <tr scope="row">
                                    ...
                                    <td><button class="app btn btn-success" data-user="<?php echo $row['uid'];?>">Approve</button></td>
                                    <td><button class="dis btn btn-danger" data-user="<?php echo $row['uid'];?>">Disapprove</button></td>
                                </tr>
                            <?php endforeach; ?> 
                        </tbody>
                    </table>
...
$(document).ready(function(){
    $('.app').click(function(event)
    {
        event.preventDefault();
            var url = "<?php echo base_url('Admin/approved_user');?>";

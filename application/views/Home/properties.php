		...
		<div class="row">
			<div class="col-md-12">
				<section id="portfolio" class="page-section section appear clearfix">
					...
					<br />
					<p>
						Here all the properties that are for buying and renting are given. Every proeprty has its own details along with owners name location and price. Every Property has aslo provide an image.Almost every property has well defined facilities. You can view the information of any property. Here you can purchase any property you like.
					<br />
						<br />
					</p>
					...
					<div class="row">
						<nav id="filter" class="col-md-12 text-center">
							<ul>
								...
								<li><a href="#" class="btn-theme btn-small" data-filter=".homes">Homes</a></li>
								<li><a href="#" class="btn-theme btn-small" data-filter=".plots">Plots</a></li>
								<li><a href="#" class="btn-theme btn-small" data-filter=".commercial">commercial</a></li>
							</ul>
						</nav>
						<div class="col-md-12">
							<div class="row">
								<div class="portfolio-items isotopeWrapper clearfix" id="3">
									...
									<article class="col-sm-4 isotopeItem plots">
										<div class="portfolio-item">
									...
									<?php endforeach;?>
									<?php foreach($commercial as $row):?>
									<article class="col-sm-4 isotopeItem commercial">
										<div class="portfolio-item">

	...
	<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<?php echo $current->project_title; echo " ";
							
						?></h3>
					</div>
					<div class="row">
						<div class="col-md-12" >
							<img src="<?php echo $current->proj_img_link;?>">
						...
						<div class="card ">
							<div class="card-body">
								...
								<div class="col-md-4">
									...
									<ul>
										<li>
												Project ID   &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <?php echo $current->project_id; ?>
										</li>
										<br>
										<li>
												Project Type   &emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <?php echo $current->type_name; ?>
										</li>
										<br>
										<li>
												Project Owner &emsp;&emsp;&emsp;&emsp;&ensp;&nbsp;&nbsp;&nbsp; <?php echo $current->full_name;?>
										</li>
										<br>
								...
								<div class="col-md-4">
									<ul>
										<li>
												Location&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;<?php echo $current->location; ?>

										</li>
										<br>
										<li>
											City &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  <?php echo $current->city;?>
										</li>
												
										<br>
										<li>
												Price &emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&ensp;&nbsp;&nbsp;&nbsp; <?php echo $current->price;?>
										</li>
										<br>
								...
								<div class="col-md-4">
									<ul>
										<li>
												Project Status&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;<?php echo $current->status; ?>

										</li>
										<br>
										<li>
												Start On &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;  <?php echo $current->starting_date;?>
										</li>
										<br>
										<li>
												Completed On &emsp;&emsp;&emsp;&emsp;&ensp;&nbsp;&nbsp; <?php echo $current->status;?>
										</li>
										<br>
    							...
    							<p style="text-align: left; text-align: justify;text-justify: inter-word;"><?php echo $current->project_description;?></p>
  						...
  						<!-- Modal content -->
							  <div class="modal-content">
							    ...
							    <div class="modal-body">
							      <p>Contact Number : <?php echo $current->contact_no;  ?></p>
							      <p>Email Address : <?php echo $current->email; ?></p>
							    </div>

  ...
  <div class="content-wrapper" style="background-image: url('<?php echo base_url('assets/back.jpg');?>')!important ;">
    ...
    <section class="content container-fluid" style="margin-top:-30px;">
        <div class="content">
            <div class="row">
                <div class="col-sm-12">
                    <a href="<?php echo base_url('Property/insert_property');?>"><?php echo form_submit(['type'=>'submit','class'=>'btn btn-info btn-md'
                        ,'value'=>'Add Property']); ?>
                    </a>
                </div>
            </div>
                        ...
                        <tbody>
                            <?php foreach($details as $row): ?>
                                <tr scope="row">
                                    ...
                                    <?php if($row['on_hold'] == 1 && $row['prop_status'] == "Available for Buying" || $row['prop_status'] == "Available for Rent")
                                    {?>
                                    <td>Available</td> 
                                    <?php } 
                                    else if ($row['on_hold'] == 0)
                                    {?>
                                     <td>On Hold</td> 
                                     <?php }
                                     else { ?>
                                    ...
                                    <td>
                                        <button data-property="<?php echo $row['propid']; ?>" data-user="<?php echo $row['propid']; ?>"type="button" class="del_property btn btn-danger btn-sm glyphicon glyphicon-trash">
                                        </button>
                                    </td>
                                    <td>
                                        <?php echo form_open('Property/edit_property'); ?>
...
$(document).ready(function(){
    $('.del_property').click(function(event)
    {
            event.preventDefault();
            var url = "<?php echo base_url('Property/delete_property'); ?>";
